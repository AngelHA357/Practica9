...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var btnSave: Button = findViewById<Button>(R.id.btn_guardar)
        ...
        userRef.addChildEventListener(object: ChildEventListener{
            ...
            override fun onChildAdded(dataSnapshot: DataSnapshot, p1: String?) {
                ...
                if (value is String && value is User){
                    val usuario = value
    ...
    private fun saveMarkFromForm(){
        var name:EditText = findViewById(R.id.et_nombre) as EditText
    ...
    private fun writeMark(mark: User){
        var listV:TextView = findViewById(R.id.tv_texto) as TextView
